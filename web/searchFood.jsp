<%-- 
    Document   : searchFood
    Created on : Jan 4, 2021, 8:08:53 PM
    Author     : Asus
--%>
    ...
    <body>        
        ...
        <header class="header">
            <div class="header__content">                
                <h2>HAN<span class="header__logo">A SHOP</span></h2>
                <nav>
                    <ul>
                                ...
                                <h3 style="margin-top: 40px;">Welcome, ${sessionScope.USERNAME}</h2>
                                    ...
                                    <c:if test="${sessionScope.USER_LOGIN.isAdmin}">
                                        <form action="DispatchServlet" style="margin-top: 25px"> 
                                            ...
                                            <li class="header__item"><a type="button" data-toggle="modal" data-target="#exampleModalLong" href="">Create Food</a></li>                                           
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">                                                            
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <input type="text" class="form-control" name="txtQuantity" value="" required>
                                                            </div>
                                                            <div class="form-row">
                                                                <label>Price</label>
                        ...
                        <li class="header__item" style="margin-top: 40px;"><a href="DispatchServlet?btnAction=Search Food">Home</a></li>
                    </ul>
                </nav>
            </div>
        </header> 
        ...
        <div style="display: flex; justify-content: center; margin: 80px 0;">
            <form action="DispatchServlet" class="d-flex" style="width: 20%; margin-right: 50px">
                <input name="txtSearchNameFood" value="${param.txtSearchNameFood}" class="form-control me-2" type="text" placeholder="Search by name of food*" aria-label="Search">
                <button style="cursor: pointer" value="Search by name" name="btnAction" class="btn btn-outline-info" type="submit">Search</button>
            </form>
            <form action="DispatchServlet" class="d-flex" style="width: 30%; margin-right: 50px">
                <input name="txtRangeMinMoney" value="${param.txtRangeMinMoney}" class="form-control me-2" type="number" placeholder="Search by range of money*" aria-label="Search">-
                <input name="txtRangeMaxMoney" value="${param.txtRangeMaxMoney}" class="form-control me-2" type="number" placeholder="Search by range of money*" aria-label="Search">
                <button style="cursor: pointer" value="Search by range" name="btnAction" class="btn btn-outline-info" type="submit">Search</button>
            </form>                              
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="DispatchServlet?btnAction=Search by category&cbCategory=F">Food</a>
                    <a class="dropdown-item" href="DispatchServlet?btnAction=Search by category&cbCategory=D">Drink</a>                
                </div>
            </div> 
        </div>  
                                ...
                                <td>
                                    <select name="cbCategory">
                                        <c:if test="${dto.categoryID == 'F'}">
                                            <option value="${dto.categoryID}">Food</option>
                                            <option value="D">Drink</option>   
                                        </c:if>
                                        <c:if test="${dto.categoryID == 'D'}">
                                            <option value="${dto.categoryID}">Drink</option>
                                            <option value="F">Food</option>   
                                        </c:if>
                                    </select>
                                </td>
