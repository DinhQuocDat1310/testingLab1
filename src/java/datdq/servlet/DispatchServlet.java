...
public class DispatchServlet extends HttpServlet {
    ...
    private final String SEARCHFOOD_CONTROLLER = "LoadPageSearchServlet";
    private final String SEARCHFOODBYNAME_CONTROLLER = "SearchFoodByNameServlet";
    private final String SEARCHFOODBYMONEY_CONTROLLER = "SearchFoodByMoneyServlet";
    private final String SEARCHFOODBYCATEGORY_CONTROLLER = "SearchFoodByCategoryServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = SEARCHFOOD_CONTROLLER;
        ...
        try {
            ...
            } else if ("Search Food".equals(button)) {
                url = SEARCHFOOD_CONTROLLER;
            } else if ("SearchFoodByNameServlet".equals(button)) {
                url = SEARCHFOODBYNAME_CONTROLLER;
            } else if ("SearchFoodByMoneyServlet".equals(button)) {
                url = SEARCHFOODBYMONEY_CONTROLLER;
            } else if ("SearchFoodByCategoryServlet".equals(button)) {
                url = SEARCHFOODBYCATEGORY_CONTROLLER;
            } else if ("Search by name".equals(button)) {
                url = SEARCHFOODBYNAME_CONTROLLER;
            } else if ("Search by range".equals(button)) {
                url = SEARCHFOODBYMONEY_CONTROLLER;
