 ...
 * @author Asus
 */
@WebServlet(name = "SearchFoodByCategoryServlet", urlPatterns = {"/SearchFoodByCategoryServlet"})
public class SearchFoodByCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("ACTIONFORM", "SearchFoodByCategoryServlet");
            request.setAttribute("ENDPAGE", endPage);
        } catch (NamingException ex) {
            Logger.getLogger(SearchFoodByCategoryServlet.class.getName()).log(Level.SEVERE, null, ex);
