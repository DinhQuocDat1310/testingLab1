...
public class HistoryDAO implements Serializable {
    ...
    public boolean insertHistory(String productID, String userID, Date updateDate, String desc) throws SQLException, NamingException {
        Connection con = null;
    ...
    public void loadHistory() throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
